...
public class EmailService implements IEmailService {
    ...
    @Override
    public Mono<Void> sendChartByEmail(String toEmail, String subject, byte[] chartData, String chartName, String projectKey) {
        return Mono.fromRunnable(() -> {
            try {
                ...
                helper.setText(
                    String.format("Please find attached the %s chart for project %s.", chartName, projectKey),
                    false
                );
