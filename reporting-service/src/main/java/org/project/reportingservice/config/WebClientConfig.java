...
/**
 * Configuration pour WebClient permettant de communiquer avec jira-fetch-service
 * Configure les timeouts, retry policies et stratégies d'échange
 */
@Configuration
public class WebClientConfig {
    ...
    public WebClient jiraFetchWebClient() {
        ...
        ConnectionProvider connectionProvider = ConnectionProvider.builder("jira-fetch-pool")
                .maxConnections(50)
    ...
    public WebClient genericWebClient() {
        return WebClient.builder()
                .exchangeStrategies(ExchangeStrategies.builder()
                        .codecs(configurer -> configurer.defaultCodecs().maxInMemorySize(8 * 1024 * 1024)) // 8MB
                        .build())
                .build();
    }
}