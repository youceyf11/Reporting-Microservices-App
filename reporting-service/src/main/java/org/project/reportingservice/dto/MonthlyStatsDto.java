...
public class MonthlyStatsDto {
     ...
     * @param hoursByMonth a map where keys are month numbers (1-12) and values are hours worked in that month
    ...
    public MonthlyStatsDto(String assignee, Map<Integer, Double> hoursByMonth, Double expectedHours) {
        ...
        this.totalMonthlyHours = hoursByMonth != null ?
                hoursByMonth.values().stream().mapToDouble(Double::doubleValue).sum() : 0.0;
        this.performanceRatio = (expectedHours != null && expectedHours > 0) ?
                (this.totalMonthlyHours / expectedHours) : 0.0;
    }
