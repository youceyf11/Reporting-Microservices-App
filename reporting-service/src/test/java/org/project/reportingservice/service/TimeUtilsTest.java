...
class TimeUtilsTest {
    ...
    class PerformanceCalculationTests {
        ...
        void determinePerformanceLevel_shouldDetermineCorrectly() {
            // Act & Assert
            assertThat(timeUtils.determinePerformanceLevel(0.95, 0.9, 0.75, 0.6)).isEqualTo("EXCELLENT"); // 95%
            assertThat(timeUtils.determinePerformanceLevel(0.80, 0.9, 0.75, 0.6)).isEqualTo("GOOD");      // 80%
            assertThat(timeUtils.determinePerformanceLevel(0.65, 0.9, 0.75, 0.6)).isEqualTo("AVERAGE");   // 65%
            assertThat(timeUtils.determinePerformanceLevel(0.40, 0.9, 0.75, 0.6)).isEqualTo("POOR");      // 40%
        }
        ...
        void determinePerformanceLevel_shouldHandleEdgeThresholds() {
            ...
            assertThat(timeUtils.determinePerformanceLevel(0.90, 0.9, 0.75, 0.6)).isEqualTo("EXCELLENT"); // Exactly 90%
            assertThat(timeUtils.determinePerformanceLevel(0.75, 0.9, 0.75, 0.6)).isEqualTo("GOOD");      // Exactly 75%
            assertThat(timeUtils.determinePerformanceLevel(0.60, 0.9, 0.75, 0.6)).isEqualTo("AVERAGE");   // Exactly 60%
        }
    }
