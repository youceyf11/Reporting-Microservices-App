...
public class ReportingDtos {
    ...
    public static class ReportingResultDto {
        ...
        public List<EmployeePerformanceDto> getEmployeeRankings() { return employeeRankings; }
        public void setEmployeeRankings(List<EmployeePerformanceDto> employeeRankings) { this.employeeRankings = employeeRankings; }
    }
