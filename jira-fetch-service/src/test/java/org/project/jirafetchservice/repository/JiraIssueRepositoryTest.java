...
class JiraIssueRepositoryTest {
    ...
    void setUp() {
        ...
        // Save test data
        jiraIssueRepository.saveAll(Arrays.asList(testIssue1, testIssue2, testIssue3))
                .blockLast();
    }
    ...
    void findById_shouldReturnEntity_whenEntityExists() {
        ...
        StepVerifier.create(jiraIssueRepository.findById(testIssue1.getIssueKey()))
                .expectNextMatches(found -> 
                    found.getIssueKey().equals("PROJ-123") &&
                    found.getStatus().equals("Open"))
                .verifyComplete();
    }
    ...
    void findById_shouldReturnEmpty_whenEntityNotExists() {
        // When & Then
        StepVerifier.create(jiraIssueRepository.findById("NONEXISTENT-001"))
                .verifyComplete();
    }
    ...
    void findByStatus_shouldReturnEmpty_whenStatusNotExists() {
        // When & Then
        StepVerifier.create(jiraIssueRepository.findByStatus("NonExistentStatus"))
                .verifyComplete();
    }
    ...
    void findByAssignee_shouldReturnEmpty_whenAssigneeNotExists() {
        // When & Then
        StepVerifier.create(jiraIssueRepository.findByAssignee("NonExistentUser"))
                .verifyComplete();
    }
    ...
    void findByIssueKey_shouldReturnMatchingEntity_whenIssueKeyExists() {
        ...
        StepVerifier.create(jiraIssueRepository.findByIssueKey("PROJ-123"))
                .expectNextMatches(found -> 
                    found.getIssueKey().equals("PROJ-123") &&
                    found.getProjectKey().equals("PROJ"))
                .verifyComplete();
    }
    ...
    void findByIssueKey_shouldReturnEmpty_whenIssueKeyNotExists() {
        // When & Then
        StepVerifier.create(jiraIssueRepository.findByIssueKey("NONEXISTENT-001"))
                .verifyComplete();
    }
    ...
    void findByProjectKey_shouldReturnEmpty_whenProjectKeyNotExists() {
        // When & Then
        StepVerifier.create(jiraIssueRepository.findByProjectKey("NONEXISTENT"))
                .verifyComplete();
    }
    ...
    void findByIssueKeyIn_shouldReturnEmpty_whenNoIssueKeysMatch() {
        ...
        // When & Then
        StepVerifier.create(jiraIssueRepository.findByIssueKeyIn(nonExistentKeys))
                .verifyComplete();
    }
    ...
    void findByIssueKeyIn_shouldHandleEmptyList() {
        ...
        // When & Then
        StepVerifier.create(jiraIssueRepository.findByIssueKeyIn(emptyList))
                .verifyComplete();
    }
    ...
    void delete_shouldRemoveEntity_whenEntityExists() {
        ...
        // When
        StepVerifier.create(jiraIssueRepository.deleteById(issueKeyToDelete))
                .verifyComplete();

        // Then - Verify entity is deleted
        StepVerifier.create(jiraIssueRepository.findById(issueKeyToDelete))
                .verifyComplete();
    ...
    void deleteAll_shouldRemoveAllEntities() {
        // When
        StepVerifier.create(jiraIssueRepository.deleteAll())
                .verifyComplete();
    ...
    void concurrentOperations_shouldHandleMultipleSimultaneousQueries() {
        ...
        Flux<JiraIssueDbEntity> concurrentQueries = Flux.merge(
    ...
    void saveAll_shouldPersistMultipleEntities() {
        // Given
        List<JiraIssueDbEntity> newIssues = Arrays.asList(
        ...
        // When & Then
        StepVerifier.create(jiraIssueRepository.saveAll(newIssues))
                .expectNextCount(3)
                .verifyComplete();
    ...
    private JiraIssueDbEntity createTestIssue(String issueKey, String status, String assignee, String projectKey) {
